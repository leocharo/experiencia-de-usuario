...
$carpeta=__DIR__ . "/video_revision/";
$fecha=date("Y-m-d");
$titulo=$_POST["titulo"];
$tema=$_POST["tema"];
...
$nombre=$limpio . "_" . basename($_FILES["video"]["name"]);
$ruta=$carpeta . $nombre;
if(move_uploaded_file($_FILES["video"]["tmp_name"], $ruta)){
    $ruta_bd = "video_revision/" . $nombre;
        // Preparar la consulta SQL
    $sql = "INSERT INTO videos_revision (titulo, tema, nivel, palabra, ruta_video, fecha_subida) VALUES (?, ?, ?, ?, ?, ?)";
